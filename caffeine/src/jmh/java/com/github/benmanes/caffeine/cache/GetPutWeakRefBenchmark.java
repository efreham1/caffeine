...
/**
 * A benchmark that evaluates the read/write performance of a cache with weak references.
 * The cache is prepopulated for a 100% hit rate and a Zipf distribution of keys is used
 * to mimic application usage patterns.
 * <p>
...
public class GetPutWeakRefBenchmark {
